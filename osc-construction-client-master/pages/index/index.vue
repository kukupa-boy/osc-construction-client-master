<template>
	<view class="container">
		<view class="cu-bar" style="background-color: #007AFF;background:url(/static/banner1.png) no-repeat; background-size: 100.2% auto;">
			<view class="action">
			  <text class="cuIcon cuIcon-back text-white"></text>
			</view>
			<view class="content text-bold">
			  <image src="/static/logo_right.png" mode="aspectFit"></image>
			</view>
			<view class="action">
		...
		<view class="container-warpper">
			...
			<view class="banner-btns">
				<button class="cu-btn"><text class="cuIcon cuIcon-back text-white"></text>统一制度</button>
				<button class="cu-btn">统一流程<text class="cuIcon cuIcon-right text-white"></text></button>
			</view>
			...
			<view class="scroll-group">
				...
				<scroll-view scroll-x class="bg-white nav imagenav" scroll-with-animation scroll-left="true">
				  <view class="cu-item first">
				    <view class="item-box">
			...
			<view class="scroll-group">
				...
				<view class="company-box">
					...
					<view class="com-item">
						<view class="title">
							<view class="title-lx">消防设计</view>
							<view class="title-sm">消防规划与建设</view>
						</view>
...
<script>
	...
	export default {
		...
		computed:{
			...mapState(['storeStatusBar','hasLogin','userInfo','rtlClazz','config']),
			i18n(){
				return this.$t('index');
			}
		},
